...
for page in range(count):
	...
	chrome.get(f"https://www.reclameaqui.com.br/empresa/vivo-celular-fixo-internet-tv/lista-reclamacoes/?pagina={page+1}")
	...
	for x in range(contador):
		...
		client = MongoClient("mongodb+srv://mayicm26:mayicm26@tcc-m2crk.mongodb.net/test?retryWrites=true&w=majority")
		db = client.reclamacoes
		collection = db.reclamacoes_vivo
		collection.insert_one(ReclameAqui)

		#reclamacoes = {"Reclamacao" : ReclameAqui}
		#reclamacoes = json.dumps(reclamacoes, indent=6, sort_keys=False)

		#arquivo_json = open('reclamaçoes_vivo.json', 'a')
