...
for page in range(count):
	...
	chrome.get(f"https://www.reclameaqui.com.br/empresa/claro/lista-reclamacoes/?pagina={page+1}")
	...
	for x in range(contador):
		...
		collection = db.reclamacoes_claro
		...
		#arquivo_json = open('reclamaçoes_claro.json', 'a')
