...
for page in range(count):
	...
	chrome.get(f"https://www.reclameaqui.com.br/empresa/tim-celular/lista-reclamacoes/?pagina={page+1}")
	...
	for x in range(contador):
		...
		#arquivo_json = open('reclamaçoes_tim.json', 'a')
